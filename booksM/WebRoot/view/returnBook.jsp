...
<script type="text/javascript" src="<%=basePath%>/view/returnBook.js"></script>
<style type="text/css">
<!--
...
<table width="99%" border="0" cellpadding="0" cellspacing="0" class="CContent">
  <tr>
      <th class="tablestyle_title" >借阅书籍
      </th>
  </tr>
  <tr>
    <td class="CPanel">
			...
			<TD width="100%">
				...
				<legend>Borrow Book</legend>
					  ...
					  <tr id="bookIsbnLable" style="display:block;">
				        <td  width="33%" align="right">请输入归还书籍的书号:</td>
						...
						<input type="button" value="归还" class="button" id="return" style="cursor: pointer;"/>　
					    </td>
						</tr>
					  </table>
			  <br />
